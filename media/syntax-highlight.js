...
SH.REGEXP = [
	...
	/((&\w+;|[-\/+*=?:.,;()\[\]{}|%^!])+)/g, SH.span('punct'),
	/\b(input|div|form|script|break|case|catch|continue|default|delete|do|else|false|finally|for|function|if|in|instanceof|new|null|return|switch|this|throw|true|try|typeof|var|void|while|with)\b/gi, SH.span('keywords'),
